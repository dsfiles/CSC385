 ...
 * update: a time delay is added to both the producer and consumer. 
	usleep(rand());
 */
...
void* producer(void* p)
{
	...
	usleep(rand()); //assume it takes 0 - 32767 micro-second to insert an item
        item = item + 1;
...
void* consumer(void* c)
{
	...
	usleep(rand()); //assume it takes 0 - 32767 micro-second to remove an item
